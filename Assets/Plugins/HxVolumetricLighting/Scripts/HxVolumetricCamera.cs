...
public class HxVolumetricCamera : MonoBehaviour
{
    ...
    hxRenderOrder RenderOrder = hxRenderOrder.ImageEffect;
...
#if HXVR
        if (Mycamera.stereoTargetEye == StereoTargetEyeMask.Both && Application.isPlaying && UnityEngine.XR.XRSettings.enabled && UnityEngine.XR.XRSettings.isDeviceActive)
        {
            return true;
        }
#endif
   ...
   // bool warned = false;
    ...
    {
#if HXVR
        if (Mycamera.stereoTargetEye != StereoTargetEyeMask.None && Application.isPlaying && UnityEngine.XR.XRSettings.enabled && UnityEngine.XR.XRSettings.isDeviceActive)
        {
